...
void dphicor_plothist(TString infname, TString outplotname, 
                      ...
                      Float_t leading_ptmin, Float_t other_ptmin, Float_t leading_trkptmin)
{
  ...
  std::vector<std::vector<TString>> drawhist = 
    {
      std::vector<TString>{"hdphi_all_all_hist", "hdphi_all_all",         "hdphi_all_all_fit",        "hdphi_subtract_all_fit"},
      std::vector<TString>{"hdphi_all_all_hist", "hdphi_all_signal_hist", "hdphi_signal_signal_hist", "hdphi_all_all", "hdphi_all_signal", "hdphi_signal_signal"},
      std::vector<TString>{"hdphi_all_all_hist", "hdphi_all_signal_hist", "hdphi_signal_signal_hist", "hdphi_all_all", "hdphi_all_signal", "hdphi_signal_signal", "hdphi_subtract_signal"},
...
int main(int argc, char* argv[])
{
  if(argc==8)
    {
      dphicor_plothist(argv[1], argv[2], argv[3], atoi(argv[4]), atof(argv[5]), atof(argv[6]), atof(argv[7]));
      return 0;
    }
  else
    {
